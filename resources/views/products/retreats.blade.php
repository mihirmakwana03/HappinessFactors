...
<div class="container py-5"><br><br><br>
    ...
    <div id="programs" class="row mb-5">
        <div class="col-12">
            <h2 class="text-center mb-4" style="color: #1565c0;">Featured Retreat Programs</h2>
        </div>
        @php
        $featuredRetreats = [
            [
            ...
            <div class="card h-100 shadow-lg border-0 hover-card">
                <div class="position-relative">
                    ...
                    <div class="position-absolute top-0 end-0 m-3">
                        <span class="badge bg-primary">{{ $retreat['duration'] }}</span>
                    </div>
                </div>
                <div class="card-body p-4">
                    <h3 class="card-title h4 mb-3" style="color: #1565c0;">{{ $retreat['title'] }}</h3>
                    <p class="card-text mb-3">{{ $retreat['desc'] }}</p>
                    <div class="mb-3">
                        <small class="text-muted"><i class="fas fa-map-marker-alt me-2"></i>{{ $retreat['location'] }}</small>
                    </div>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <h2 class="text-center mb-4" style="color: #1565c0;">Benefits of Our Retreats</h2>
        </div>
        <div class="col-md-3 mb-4">
            <div class="text-center p-4">
                <i class="fas fa-brain fa-3x mb-3" style="color: #1565c0;"></i>
        ...
        <div class="col-md-3 mb-4">
            <div class="text-center p-4">
                <i class="fas fa-dumbbell fa-3x mb-3" style="color: #1565c0;"></i>
    ...
    <div class="row mb-5">
        <div class="col-12">
            <h2 class="text-center mb-4" style="color: #1565c0;">Retreat Experiences</h2>
        </div>
        @php
        $testimonials = [
            [
    ...
    <div class="row">
        <div class="col-12">
            <div class="p-5 rounded text-center" style="background: linear-gradient(135deg, #bbdefb 0%, #e3f2fd 100%);">
                <h2 class="mb-4" style="color: #1565c0;">Ready to Begin Your Journey?</h2>
