...
<div class="container py-5"><br><br><br>
    ...
    <div class="row mb-5">
        <div class="col-12 text-center">
            <hr class="my-4 w-25 mx-auto">
            <h2 class="h2 mb-4"></h2>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-stars me-2" viewBox="0 0 16 16"></svg>
    ...
    <div class="row">   
        <div class="col-lg-4 mb-4">
            <div class="card h-100 shadow-sm border-0 hover-card">
                <img src="https://images.unsplash.com/photo-1521791136064-7986c2920216?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" class="card-img-top" alt="Effective Relationships">
                <div class="card-body p-4"> 
        ...
        <div class="col-lg-4 mb-4">
            <div class="card h-100 shadow-sm border-0 hover-card">
                <img src="https://images.unsplash.com/photo-1552581234-26160f608093?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" class="card-img-top" alt="Happiness And Success">
                <div class="card-body p-4">
        ...
        <div class="col-lg-4 mb-4"> 
            <div class="card h-100 shadow-sm border-0 hover-card">  
                <img src="https://images.unsplash.com/photo-1512438248247-f0f2a5a8b7f0?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" class="card-img-top" alt="Managing Stress">
                <div class="card-body p-4">
                    <h3 class="card-title text-primary"><i class="bi bi-wind me-2"></i>Managing Stress*</h3>
    ...
    <div class="row">   
        <div class="col-lg-4 mb-4">
            <div class="card h-100 shadow-sm border-0 hover-card">  
                <img src="https://images.unsplash.com/photo-1499750310107-5fef28a66643?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80" class="card-img-top" alt="Work-Life Integration">
                <div class="card-body p-4">
    ...
    <div class="row mt-5">
        <div class="col-md-8 mx-auto text-center">  
            <div class="bg-light p-4 rounded-3 shadow-sm">  
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-chat-heart text-primary mb-3" viewBox="0 0 16 16"></svg>
