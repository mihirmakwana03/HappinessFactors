    ...
    <div class="container py-5">
        <div class="row footer-content justify-content-center">
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-4">
                ...
                <ul class="list-unstyled footer-link-list">
                    ...
                    <li class="mb-3"><a href="<?php echo e(url('https://apps.apple.com/us/app/happiness-factors/id1575587044')); ?>">App</a></li>
                    ...
                    <li class="mb-3"><a href="<?php echo e(url('/products/webinars')); ?>">Webinars</a></li>
                    <li class="mb-3"><a href="<?php echo e(url('/products/seminars')); ?>">Seminars</a></li>
                    <li class="mb-3"><a href="<?php echo e(url('/products/workshops')); ?>">Workshops</a></li>
                    <li class="mb-3"><a href="<?php echo e(url('/products/offsites')); ?>">Offsites</a></li>
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-4">
                ...
                <ul class="list-unstyled footer-link-list">
                    ...
                    <li class="mb-3"><a href="<?php echo e(url('/terms-and-conditions')); ?>">Terms & Conditions</a></li>
                    <li class="mb-3"><a href="<?php echo e(url('/privacy-policy')); ?>">Privacy Policy</a></li>
            ...
            <div class="col-lg col-md-6 col-sm-12 mb-4">
                ...
                <div class="d-flex flex-column align-items-center">
                    <a href="<?php echo e(url('https://apps.apple.com/us/app/happiness-factors/id1575587044')); ?>" target="_blank" class="mb-3 app-store-link">
                        <lottie-player 
                            src="<?php echo e(asset('assets/json/App-Store.json')); ?>" 
                    ...
                    <a href="#" target="_blank" class="google-play-link">
                        <lottie-player 
                            src="<?php echo e(asset('assets/json/Google-Play.json')); ?>" 
                            background="transparent" 
                            speed="0.5" 
        ...
        <div class="row copyright-row align-items-center">
            <div class="col-md-6 text-center text-md-left mb-2 mb-md-0">
                <p class="mb-0 copyright-text">&copy; <?php echo e(date('Y')); ?> HappinessFactors. All Rights Reserved.</p>
            </div>
...
</script><?php /**PATH D:\HappinessFactors\resources\views/components/footer.blade.php ENDPATH**/ ?>