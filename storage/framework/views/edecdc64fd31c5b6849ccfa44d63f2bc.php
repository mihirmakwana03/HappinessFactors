<?php $__env->startSection('title', 'Workshops - Happiness Factors'); ?>
<?php $__env->startSection('description', 'Join our transformative workshops designed to enhance your personal and professional growth through interactive learning experiences.'); ?>
<?php $__env->startSection('keywords', 'Workshops, Personal Development, Professional Growth, Interactive Learning, Happiness Factors'); ?>
<?php $__env->startSection('og-image', asset('images/workshop-banner.jpg')); ?>
<?php $__env->startSection('og-title', 'Workshops - Happiness Factors'); ?>
<?php $__env->startSection('og-description', 'Transform your life with our interactive workshops that combine science-backed strategies with practical tools for success.'); ?>
            ...
            <div class="card shadow-lg border-0 mb-5" style="border-radius: 20px; overflow: hidden;">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        <h2 class="h1 mb-3" style="color: #0d47a1;">🎯 Ready to Level Up?</h2>
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6 mb-4">
                            <div class="feature-box p-4 h-100" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); border-radius: 15px;">
                                <h3 class="h4 mb-3" style="color: #1565c0;">✨ Why This Workshop?</h3>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="feature-box p-4 h-100" style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); border-radius: 15px;">
                                <h3 class="h4 mb-3" style="color: #1565c0;">🔧 What You'll Walk Away With:</h3>
                    ...
                    <div class="alert alert-info mt-4 mb-4" style="background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); border: none; border-radius: 15px;">
                        <div class="d-flex align-items-center">
                            <i class="fas fa-calendar-alt fa-2x me-3" style="color: #1565c0;"></i>
                            <div>
                                <h4 class="h5 mb-1" style="color: #0d47a1;">📅 Limited Spots Available!</h4>
                    ...
                    <div class="text-center mt-5">
                        <a href="tel:+14083893073" class="btn btn-primary btn-lg px-5 py-3" style="background: linear-gradient(135deg, #1565c0, #0d47a1); border: none; border-radius: 30px; font-weight: 600; box-shadow: 0 4px 15px rgba(21, 101, 192, 0.2);">
...
<?php echo $__env->make('main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\LENOVO\Desktop\happiness-factors\resources\views/products/workshops.blade.php ENDPATH**/ ?>